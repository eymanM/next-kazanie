...
- Stripe Checkout
  - Custom Amount Donation with redirect to Stripe Checkout:
    - Server Componentt: [app/donate-with-checkout/page.tsx](app/donate-with-checkout/page.tsx)
...
- Stripe Elements
  - Custom Amount Donation with Stripe Payment Element & PaymentIntents:
    - Server Componentt: [app/donate-with-elements/page.tsx](app/donate-with-elements/page.tsx)
    - Server Action: [app/actions/stripe.ts](app/actions/stripe.ts)
